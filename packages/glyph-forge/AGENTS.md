...
Python renderer + manifest builder. Feeds SVGs and a BrokenGlyph JSON into `apps/glyph-forge`. Does not run at request time — build cache at dev/build, serve static.
