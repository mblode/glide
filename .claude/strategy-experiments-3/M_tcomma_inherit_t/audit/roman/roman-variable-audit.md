...
- source: `/Users/mblode/Code/mblode/glide/.claude/strategy-experiments-3/M_tcomma_inherit_t/glide-variable.glyphs`
- designspace: `/Users/mblode/Code/mblode/glide/master_ufo/Glide.designspace`
- variable font: `/Users/mblode/Code/mblode/glide/.claude/strategy-experiments-3/M_tcomma_inherit_t/audit-build/roman/glide-variable-audit-vf.ttf`
- samples per span: `4`
...
- `wght 280` riskyGlyphs=203 riskTypes={"intersections": 3, "short_segment": 200}
- `wght 340` riskyGlyphs=206 riskTypes={"short_segment": 206}
- `wght 400` riskyGlyphs=201 riskTypes={"short_segment": 201}
- `wght 510` riskyGlyphs=201 riskTypes={"intersections": 4, "short_segment": 199}
- `wght 620` riskyGlyphs=198 riskTypes={"intersections": 7, "short_segment": 197}
- `wght 730` riskyGlyphs=205 riskTypes={"intersections": 8, "short_segment": 204}
- `wght 840` riskyGlyphs=207 riskTypes={"intersections": 6, "short_segment": 207}
...
- `emacron` focusSeverity=240 interpolatable=0 issueTypes=[] interiorWeights=[160, 220, 280, 340, 510, 620, 730, 840] spanRiskWeights={"regular_to_extrablack": [510, 620, 730, 840], "thin_to_regular": [160, 220, 280, 340]} maxIntersections=6 minSegment=0.2
...
- `iogonek` severity=425 interpolatable=1 issueTypes=['kink'] riskyWeights=[100, 160, 220, 280, 340, 400, 510, 620, 730, 840, 950] maxIntersections=0 minSegment=0.88 masterDeviationWeights=[] masterAreaWeights=['100']
