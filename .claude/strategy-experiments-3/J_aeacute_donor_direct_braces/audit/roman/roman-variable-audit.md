...
- source: `/Users/mblode/Code/mblode/glide/.claude/strategy-experiments-3/J_aeacute_donor_direct_braces/glide-variable.glyphs`
- designspace: `/Users/mblode/Code/mblode/glide/master_ufo/Glide.designspace`
- variable font: `/Users/mblode/Code/mblode/glide/.claude/strategy-experiments-3/J_aeacute_donor_direct_braces/audit-build/roman/glide-variable-audit-vf.ttf`
- samples per span: `4`
...
- `wght 100` pointMismatch=685 deviations=31 areaDiffs=58
- `wght 400` pointMismatch=684 deviations=32 areaDiffs=15
- `wght 950` pointMismatch=689 deviations=27 areaDiffs=57
...
- `wght 510` riskyGlyphs=201 riskTypes={"intersections": 6, "short_segment": 199}
- `wght 620` riskyGlyphs=198 riskTypes={"intersections": 8, "short_segment": 197}
- `wght 730` riskyGlyphs=205 riskTypes={"intersections": 9, "short_segment": 204}
- `wght 840` riskyGlyphs=207 riskTypes={"intersections": 8, "short_segment": 207}
...
- `aeacute` focusSeverity=280 interpolatable=0 issueTypes=[] interiorWeights=[160, 220, 280, 340, 510, 620, 730, 840] spanRiskWeights={"regular_to_extrablack": [510, 620, 730, 840], "thin_to_regular": [160, 220, 280, 340]} maxIntersections=8 minSegment=0.2
...
- `aeacute` severity=475 interpolatable=0 issueTypes=[] riskyWeights=[100, 160, 220, 280, 340, 400, 510, 620, 730, 840, 950] maxIntersections=8 minSegment=0.2 masterDeviationWeights=[] masterAreaWeights=[]
