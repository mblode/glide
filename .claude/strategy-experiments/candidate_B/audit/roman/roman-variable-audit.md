...
- source: `/Users/mblode/Code/mblode/glide/.claude/strategy-experiments/candidate_B/glide-variable.glyphs`
- designspace: `/Users/mblode/Code/mblode/glide/master_ufo/Glide.designspace`
- variable font: `/Users/mblode/Code/mblode/glide/.claude/strategy-experiments/candidate_B/audit-build/roman/glide-variable-audit-vf.ttf`
- samples per span: `4`
...
- sampled_risky_glyphs: `382`
- glyphs_with_intersections: `16`
- glyphs_with_zero_ink: `0`
- glyphs_with_short_segments: `382`
- master_validation_point_problem_glyphs: `716`
- master_validation_area_problem_glyphs: `65`
...
- clean_glyphs: `492`
- interpolatable_problem_glyphs: `66`
- sampled_risky_glyphs: `254`
- glyphs_with_span_risk: `254`
- glyphs_risky_in_all_spans: `205`
- glyphs_with_intersections: `15`
- glyphs_with_zero_ink: `0`
- glyphs_with_short_segments: `251`
- span_problem_glyphs: `{"regular_to_extrablack": 223, "thin_to_regular": 236}`

## Interpolatable

- summary: `{"issue_types": {"kink": 19, "underweight": 65, "wrong_start_point": 5}, "problem_glyphs": 70}`

## Exact Masters

- `wght 100` pointMismatch=687 deviations=29 areaDiffs=55
- `wght 400` pointMismatch=686 deviations=30 areaDiffs=15
- `wght 950` pointMismatch=690 deviations=26 areaDiffs=55

## Sampled Weights

- `wght 100` riskyGlyphs=336 riskTypes={"intersections": 2, "short_segment": 336}
- `wght 160` riskyGlyphs=225 riskTypes={"intersections": 5, "short_segment": 223}
- `wght 220` riskyGlyphs=207 riskTypes={"intersections": 4, "short_segment": 204}
- `wght 280` riskyGlyphs=204 riskTypes={"intersections": 4, "short_segment": 201}
- `wght 340` riskyGlyphs=207 riskTypes={"intersections": 1, "short_segment": 207}
- `wght 400` riskyGlyphs=202 riskTypes={"intersections": 1, "short_segment": 202}
- `wght 510` riskyGlyphs=202 riskTypes={"intersections": 5, "short_segment": 200}
- `wght 620` riskyGlyphs=199 riskTypes={"intersections": 8, "short_segment": 198}
- `wght 730` riskyGlyphs=205 riskTypes={"intersections": 9, "short_segment": 204}
- `wght 840` riskyGlyphs=209 riskTypes={"intersections": 7, "short_segment": 209}
- `wght 950` riskyGlyphs=228 riskTypes={"intersections": 1, "short_segment": 228}

## Interpolation Priority Glyphs

- `uni021B.1` focusSeverity=440 interpolatable=0 issueTypes=[] interiorWeights=[160, 220, 280, 340, 510, 620, 730, 840] spanRiskWeights={"regular_to_extrablack": [510, 620, 730, 840], "thin_to_regular": [160, 220, 280, 340]} maxIntersections=116 minSegment=0.0
...
- `uni021B.1` severity=605 interpolatable=0 issueTypes=[] riskyWeights=[100, 160, 220, 280, 340, 400, 510, 620, 730, 840, 950] maxIntersections=116 minSegment=0.0 masterDeviationWeights=[] masterAreaWeights=[]
