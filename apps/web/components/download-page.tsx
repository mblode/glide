      ...
      <div className="mx-auto w-full max-w-2xl space-y-8 px-4 py-16 sm:px-6 sm:py-24">
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            applications and browsers. If you encounter software that does not
            support variable fonts, the web WOFF2 files below include static
            cuts at 400, 500, 700, and 900.
          </p>
        </section>
