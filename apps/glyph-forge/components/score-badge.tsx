...
import { scoreBand, type ScoreBand } from "@/lib/data";
...
const BAND_CLASS: Record<ScoreBand, string> = {
  ...
  unknown:
    "bg-[--color-band-unknown]/15 text-muted-foreground/70 ring-border",
};
  ...
  return (
    <span
      ...
      className={cn(
        ...
        compact ? "h-4 min-w-[1.9rem] text-[10px]" : "h-5 min-w-[2.2rem] text-xs",
        BAND_CLASS[band],
        className
      )}
    >
